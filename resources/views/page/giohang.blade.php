				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="{{$product['item']['ImageLink'].'.jpg'}}" alt="IMG">
										</div>
									</td>
									<td class="column-2">{{$product['item']['tensp']}}</td>
									<td class="column-3">{{$product['item']['giakm']}}</td>
									<td class="column-4">
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10", style="font-weight: bold;">
								Cập nhật giỏ hàng
							</div>
						</div>
					</div>
