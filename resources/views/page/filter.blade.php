          ...
          <div class="dis-none panel-filter w-full p-t-10">
            ...
            >
              <div class="filter-col2 p-r-15 p-b-27">
                ...
                <!-- <ul>
                  <li class="p-b-6">
                    <a href="{{route('filter',0,50)}}" class="filter-link stext-106 trans-04">
                      $0.00 - $50.00
                    </a>
                  </li>

                  <li class="p-b-6">
                    <a href="{{route('filter',50,100)}}" class="filter-link stext-106 trans-04">
                      $50.00 - $100.00
                    </a>
                  </li>

                  <li class="p-b-6">
                    <a href="{{route('filter',100,10000)}}" class="filter-link stext-106 trans-04">
                      $100.00+
                    </a>
                  </li>
